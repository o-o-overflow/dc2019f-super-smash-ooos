...
Module["build"] = function (binaryData) {
...
// Memory management
    ...
    var STATIC_BASE = 1024,
        ...
        STACKTOP = STACK_BASE,
        STACK_MAX = 5265456,
        DYNAMIC_BASE = 5265456,
        DYNAMICTOP_PTR = 22320;
...
// Indicates whether filename is a base64 data URI.
    ...
    var wasmBinaryFile = 'compotp.wasm';
...
// EMSCRIPTEN_START_ASM
    ...
    var real__compute_otp = asm["_compute_otp"];
    asm["_compute_otp"] = function () {
        assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
        assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
        return real__compute_otp.apply(null, arguments);
    };
    ...
    var _compute_otp = Module["_compute_otp"] = function () {
        assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
        assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
        return Module["asm"]["_compute_otp"].apply(null, arguments)
    };
